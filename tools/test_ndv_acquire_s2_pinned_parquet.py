...
class AcquisitionTests(unittest.TestCase):
    def snapshot(self, data: bytes = b"fixture"):
        return {"dataset": "org/data", "pinned_revision": "a" * 40, "parquet_path": "data/train.parquet", "parquet_remote_size_bytes": len(data), "parquet_sha256": hashlib.sha256(data).hexdigest()}
    ...
    def test_download_streams_to_partial(self, urlopen):
        cm = mock.MagicMock()
        cm.__enter__.return_value = io.BytesIO(b"abcdef")
