...
def binding_record(v:dict[str,Any],artifact_root:Path)->dict[str,Any]:
    b=v["b"]; return {"binding_id":b["binding_id"],"binding_ref":rel(v["bpath"],artifact_root),"binding_file_sha256":sha_file(v["bpath"]),"qualification_ref":rel(v["qpath"],artifact_root),"qualification_file_sha256":sha_file(v["qpath"]),"evidence_manifest_ref":rel(v["manifest_path"],artifact_root),"evidence_manifest_sha256":sha_file(v["manifest_path"]),"execution_surface_ref":rel(v["surface_path"],artifact_root),"execution_surface_file_sha256":sha_file(v["surface_path"]),"exact_executor_identity":b["exact_executor_identity"],"surface_class":"SUBSCRIPTION_EXECUTOR_PINNED"}
